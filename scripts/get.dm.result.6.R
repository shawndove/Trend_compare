                          ...
                          y)
{
  ...
  ggsave(paste(wd, "/plots/test_results_temp/", print_name, "_plots.jpg", sep=""), p.all)
  
  # write the flextable as a Word document
  save_as_docx(tr_table, 
               path = paste(wd, "/tables/test_results_temp/", print_name, "_table.docx", sep=""))
  
  # write the wide-form data table to an R file
  saveRDS(tr_wide, file = paste(wd, "/files/wide_temp/", print_name, "_dfwide.RData", sep=""))
